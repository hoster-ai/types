...
**Description:** Numeric input field. Discriminator type='NUMBER'. Optional min/max (validated via @MinLessOrEqualMaxProperty) and integer flag.

**Source:** `dtos/fields/number-field.dto.ts`
