...
**Description:** Abstract base for every concrete field DTO. Carries id, label, required, disabled, hidden, triggersRemoteValidation, remoteValidationErrorMessage, upgradable, downgradable. Concrete classes add a string-literal 'type' discriminator, a typed value, and any type-specific options.

**Source:** `dtos/base-field.dto.ts`
