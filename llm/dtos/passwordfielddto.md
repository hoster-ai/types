...
**Description:** Password input field. Discriminator type='PASSWORD'. Value is a string with optional minLength. Does NOT enforce password strength rules — that is the consumer's responsibility.

**Source:** `dtos/fields/password-field.dto.ts`
