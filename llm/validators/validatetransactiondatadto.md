# validateTransactionDataDto

**Description:** Validates a TransactionData object using class-validator decorators.

**Source:** `validators/transaction-data-validator.ts`
