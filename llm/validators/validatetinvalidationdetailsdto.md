# validateTINValidationDetailsDto

**Description:** Validates a TINValidationDetails object using class-validator decorators.

**Source:** `validators/tin-validation-details-validator.ts`
