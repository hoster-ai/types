# validateAttributeFieldDto

**Description:** Validates an AttributeFieldDto. The nested .field (a discriminated AnyFieldDto) is validated separately via validateAnyFieldDto and its errors are merged under the 'field' property.

**Source:** `validators/attribute-field-validator.ts`
