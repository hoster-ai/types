# validateInvoiceItemDataDto

**Description:** Validates an InvoiceItemDataDto object using class-validator decorators.

**Source:** `validators/invoice-item-data-validator.ts`
