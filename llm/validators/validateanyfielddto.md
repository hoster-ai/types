...
**Description:** Dispatcher that reads the string-literal 'type' discriminator and routes to the matching concrete DTO's validation. Returns a synthetic ValidationError on .type if the discriminator is missing or unknown.

**Source:** `validators/any-field-validator.ts`
